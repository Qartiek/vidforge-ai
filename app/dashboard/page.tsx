...
export default async function Dashboard() {
  ...
  return <main className="container">
    <nav className="nav"><a href="/dashboard" className="logo" style={{textDecoration:"none"}}>VidForge AI</a><div className="nav-actions"><span className="status-dot"/> COMMAND CENTER <span className="muted">{user.name || user.email}</span><a className="nav-link" href="/jobs">Jobs</a><a className="nav-link" href="/pricing">Plans</a></div></nav>
