...
const settings = [
  ["Profile", "Account, name and preferences"], ["Appearance", "Theme, density and interface"], ["AI Preferences", "Models, creativity and defaults"], ["Video Defaults", "Format, quality and duration"], ["Voice & Captions", "Audio, voice and subtitle defaults"], ["Brand Kit", "Logo, colors and brand assets"], ["Notifications", "Email and product alerts"], ["Integrations", "YouTube, AI, storage and providers"], ["Privacy & Security", "Sessions, password and privacy"], ["Billing & Usage", "Plan, usage and invoices"], ["Developer", "API and automation settings"],
];
